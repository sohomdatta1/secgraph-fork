...
public class MinWeightHungarianAlgorithm{


    public static void main(String[] args) {
        float[][] test ={{2,3,1},{4,5,6},{8,7,9}};
        int[][] testResult = new MinWeightHungarianAlgorithm()
                .computeAssignments(test);
        //System.out.println(testResult.length);
        //System.out.println(testResult[0].length);
